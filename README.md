...
<img src="https://user-images.githubusercontent.com/56102421/84663819-a3e68d80-af58-11ea-8249-9c25f79410e8.png" width="30%" > 

네이버밴드 뷰의 구성은 스크롤뷰 내에 세가지 콜렉션뷰가 있었다. 구현하면서 헤맸던 부분이라기보다 새로 알게 되었던 점은, 스토리보드를 나누어 작업하는 방법이다. 깃헙으로 서로 협업할 때 스토리보드가 충돌이 나면 해결이 거의 불가능하다! 감으로 xml언어를 건드려야 하는데 이럴 때 잘못 지울 수도 있고, 영원히 복구를 못 시킬 수 있다. 따라서 스토리보드를 나누고, 뷰컨은 코드로 이어주는 것이 필요하다. 탭바컨트롤러를 만들어 코드로 아이콘과 탭제목을 넣어주었고, 각 뷰컨을 이어주었다.

새로운 점을 알게된 뷰는 아니어서 코드는 첨부 ❌ 

아래는 구현영상이다. 



​        <img src="https://user-images.githubusercontent.com/56102421/84663521-44887d80-af58-11ea-9627-6784c4d5d6be.gif" width="30%" > 



ps  **동민이형 너무 수고했어 🙇‍♂️🙇‍♂️🙇‍♂️** 
